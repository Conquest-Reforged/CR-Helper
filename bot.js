    ...
    if (msg.content.substring(0, 1) === '!') {
        ...
        switch(cmd) {
            case 'installMod1.15':
                ...
                '4. Download the "Alpha" .jar file from the respective link in the #files channel.\n' +
                ...
                '7. Download the Conquest Reforged Resourcepack from the "AlphaRP" link in #files. Drop it into your folder at `C:\\Users\\<user-name>\\AppData\\Roaming\\.minecraft\\resourcepacks` You\'ll have to enable the resourcepack once the game has launched and enable connected textures in Video Options.\n\n' +
